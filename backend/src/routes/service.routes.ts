...
import { allTheServices, createService, deactivateService } from '../controllers/service.controllers.js'
...
router.post('/excluirServico', defaultLimiter, verificarToken, verificarRole, deactivateService)
